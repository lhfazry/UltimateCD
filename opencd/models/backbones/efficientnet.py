...
class EfficientNet(BaseModule):
    ...
    def __init__(self, model_name, in_channels=3, num_classes=2, return_inputs=True, 
                 **override_params):
        super().__init__()
        EfficientNet._check_model_name_is_valid(model_name)
        blocks_args, global_params = get_model_params(model_name, override_params) 
        global_params.include_top = False     

        self.return_inputs = return_inputs
        self._change_in_channels(in_channels)
        load_pretrained_weights(self, model_name, weight_paths=None, 
    ...
    def extract_features(self, inputs):
        ...
        outs = [inputs] if self.return_inputs else []
