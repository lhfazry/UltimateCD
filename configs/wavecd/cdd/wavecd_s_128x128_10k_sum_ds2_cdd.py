...
train_pipeline = [
    ...
    dict(type='MultiImgAlbu', transforms=[dict(type='Downscale', 
                                               interpolation=dict(downscale=cv2.INTER_AREA,
...
fp16 = dict()
work_dir = './work_dirs/wavecd/cdd/wavecd_s_128x128_10k_sum_ds2_cdd'