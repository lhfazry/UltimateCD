...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Generate .txt file for CD dataset')
    parser.add_argument('dataset_folder', help='path of dataset')
    parser.add_argument('preimage_folder', default='A')
    parser.add_argument('postimage_folder', default='B')
    parser.add_argument('list_folder', default='list')
...
def generate_txt_from_dir(src_dir, dst_dir, split):
    """Generate .txt file for CDD dataset.
...
def main():
    ...
    preimage_folder = args.preimage_folder
    postimage_folder = args.postimage_folder
